...
class Top(generic.TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'register/top.html', context)
    
    def post(self, request, *args, **kwargs):
        context = {
            'url': request.POST['url'],
        }
        videourl = context['url']
        #print(videourl)
        write_data.write_csv(videourl)     
        return HttpResponseRedirect("/media/apifile/channel.csv")
        return render(request, 'register/top.html', context)
